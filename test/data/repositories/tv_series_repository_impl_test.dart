...
import 'package:ditonton/data/models/tvseries/tv_series_genre_model.dart';
...
void main() {
  ...
  group('Get Tv Series Detail', () {
    ...
    final tTvSeriesResponse = TvSeriesDetailResponse(
      ...
      backdropPath: '/path.jpg',
      firstAirDate: DateTime.parse('2020-05-05'),
      genres: [TvSeriesGenreModel(id: 1, name: 'Action')],
      inProduction: true,
      id: 1,
      lastAirDate: DateTime.parse('2020-05-05'),
      originalLanguage: 'en',
      name: 'name',
      overview: 'overview',
      popularity: 1,
